...
def load_store_db(fname_store_data):
    ...
    print(dict_vendor.keys())
    print(dict_vendor['0203'].keys())
    print(dict_vendor['0203']['NISH51892'].keys())
    '''

    '''
    dict_vendor = np.load('./bin_store_data/'+fname_store_data+'.npy', allow_pickle=True).item()
    print(dict_vendor.keys())
    print(dict_vendor['0203'].keys())
    print(dict_vendor['0203']['NISH51892'].keys())
    '''
...
def convert_store_data(f):
    ...
    if isfile(file):
        ...
        np.save(file_targ_bin+'.npy', dict_vendor_bin)
        '''
...
def process_step_four(thread_id, g_data, param1):
    ...
    list_non_srp_store_date = [['파일명', 'F01', 'F1000', 'F27', 'F26', 'F19', 'F39', 'F1122', 'Old Case Cost', 'New Case Cost', 'Active Price', 'Old Margin', 'New Margin'], ]
    list_srp_store_data_upon_zero_margin = [['파일명', 'F01', 'F1000', 'F27', 'F26', 'F19', 'F39', 'F1122', 'Old Case Cost', 'New Case Cost', 'Active Price', 'Old Margin', 'New Margin', 'F30'], ]
    list_srp_minus_margin = [['파일명', 'F01', 'F1000', 'F27', 'F26', 'F19', 'F39', 'F1122', 'Old Case Cost', 'New Case Cost', 'Active Price', 'Old Margin', 'New Margin', 'F30'], ]
    header = []
            ...
            for row in ws_t.rows:
                ...
                if arr1[5] is not None and arr1[5] != '':
                    try:
                        if not((tmp_vc is None or tmp_vc == '') and (tmp_ic is None or tmp_ic == '') and (tmp_sc is None or tmp_sc == '') and (tmp_upc is None or tmp_upc == '')):
                            ...
                            if result_srp != None and result_srp != '' and result_srp != ' ':
                                ...
                                dict_srp_store_date[str(tmp_sc)+'_'+str(tmp_date)].append([result_upc, '', tmp_sc, tmp_vc, result_ic, 'CASE', '1', '1', result_csize, tmp_ncost, tmp_date, '1', tmp_vat, result_old_case_cost, result_new_case_cost, result_price, result_old_margin, result_new_margin, result_srp])
                                if result_new_margin > 0:
                                    list_srp_store_data_upon_zero_margin.append([row[1].value, result_upc, tmp_sc, tmp_vc, result_ic, result_csize, tmp_date, tmp_vat, result_old_case_cost, result_new_case_cost, result_price, result_old_margin, result_new_margin, result_srp])
                                else:
                                    list_srp_minus_margin.append([row[1].value, result_upc, tmp_sc, tmp_vc, result_ic, result_csize, tmp_date, tmp_vat, result_old_case_cost, result_new_case_cost, result_price, result_old_margin, result_new_margin, result_srp])
                            elif result_desc_lookup_base in ['U', 'I']:
                                list_non_srp_store_date.append([row[1].value, result_upc, tmp_sc, tmp_vc, result_ic, result_csize, tmp_date, tmp_vat, result_old_case_cost, result_new_case_cost, result_price, result_old_margin, result_new_margin])
                    except Exception as ex:
                        f_error_log = open(file_error_log, 'a')
                        flag_error = 1
                        f_error_log.write(f + '\t' + str(idx1 + 1) + '\t' + str(traceback.format_exc()) + '\n')
                    ...
                    if tmp_srp != None and tmp_srp != '' and tmp_srp != ' ':
                        if str(tmp_sc)+'_'+str(tmp_date) not in dict_srp_store_date:
                            dict_srp_store_date[str(tmp_sc)+'_'+str(tmp_date)] = []
                        dict_srp_store_date[str(tmp_sc)+'_'+str(tmp_date)].append([result_upc, '', tmp_sc, tmp_vc, tmp_ic, 'CASE', '1', '1', tmp_csize, tmp_ncost, tmp_date, '1', tmp_vat, result_old_case_cost, result_new_case_cost, result_price, result_old_margin, result_new_margin, tmp_srp])
                        if result_new_margin > 0:
                            list_srp_store_data_upon_zero_margin.append([row[1].value, result_upc, tmp_sc, tmp_vc, tmp_ic, tmp_csize, tmp_date, tmp_vat, result_old_case_cost, result_new_case_cost, result_price, result_old_margin, result_new_margin, tmp_srp])
                        else:
                            list_srp_minus_margin.append([row[1].value, result_upc, tmp_sc, tmp_vc, tmp_ic, tmp_csize, tmp_date, tmp_vat, result_old_case_cost, result_new_case_cost, result_price, result_old_margin, result_new_margin, tmp_srp])
                    elif tmp_desc_lookup_base in ['U', 'I']:
                        list_non_srp_store_date.append([row[1].value, result_upc, tmp_sc, tmp_vc, tmp_ic, tmp_csize, tmp_date, tmp_vat, result_old_case_cost, result_new_case_cost, result_price, result_old_margin, result_new_margin])
