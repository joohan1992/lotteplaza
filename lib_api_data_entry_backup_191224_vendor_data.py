...
def data_lookup(g_data, tmp_upc, tmp_sc, tmp_vc, tmp_ic, tmp_csize, tmp_ncost, tmp_upc_cand2, tmp_vat, dict_error_flag, dict_vendor, dict_vend, param_etc=None):
    # print('#2')
    ...
    return result_upc, result_ic, result_desc, result_csize, result_ccost, result_upc_check, result_upc_same_check, result_desc_lookup_base, result_old_case_cost, result_new_case_cost, result_price, result_old_margin, result_new_margin, result_srp, tmp_upc_cand2, detail_cat
            ...
            try:
                for row in ws_t.rows:
                    ...
                    if (tmp_vc is None or tmp_vc == '') and (tmp_ic is None or tmp_ic == '') and (tmp_sc is None or tmp_sc == '') and (tmp_upc is None or tmp_upc == ''):
                        break
                    if tmp_vc in ('0202', '0203') and (row[15].value is None or row[15].value not in ['c', 'C', 'e', 'E']):
                        f_error_log = open(file_error_log, 'a')
                        flag_error = 1
                    ...
                    param_etc['file_nm'] = f
                    result_upc, result_ic, result_desc, result_csize, result_ccost, result_upc_check, result_upc_same_check, result_desc_lookup_base, result_old_case_cost, result_new_case_cost, result_price, result_old_margin, result_new_margin, result_srp, tmp_upc_cand2, detail_cat = data_lookup(g_data, tmp_upc, tmp_sc, tmp_vc, tmp_ic, tmp_csize, tmp_ncost, tmp_upc_cand2, tmp_vat, dict_error_flag, dict_vendor, dict_vend, param_etc)
            ...
            for row in ws_t.rows:
                try:
                    ...
                    if tmp_vc is None or len(tmp_vc) != 4:
                        ...
                        f_error_log.close()
                        break
                    result_old_case_cost = row[29].value
                    if row[29].value is None:
                        result_old_case_cost = ''
                    result_new_case_cost = row[30].value
                    if row[30].value is None:
                        result_new_case_cost = ''
                    result_price = row[31].value
                    if row[31].value is None:
                        result_price = ''
                    result_old_margin = row[32].value
                    if row[32].value is None:
                        result_old_margin = ''
                    result_new_margin = row[33].value
                    if row[33].value is None:
                        result_new_margin = ''
                    ...
                    if key_item in dict_item:
                        ...
                        dict_item[key_item]['amount'] += float(row[26].value)
                    ...
                    # 중복되는 제품이 없는 경우 dict에 넣어 줌
                        ...
                        dict_item[key_item] = {
                            ...
                            , 'key_srp_non': len(list_non_srp_store_date) if (tmp_srp is None or tmp_srp == '' or tmp_srp == ' ') and tmp_desc_lookup_base in ['U', 'I'] else -1
                ...
                # 수정 사항이 없는 경우
                    ...
                    if str(tmp_sc)+'_'+str(tmp_date) not in dict_srp_store_date:
                        dict_srp_store_date[str(tmp_sc)+'_'+str(tmp_date)] = []
                    key_item = str(arr1[1])+'_+_'+str(result_upc)+'_+_'+str(result_ic)
                    # 중복되는 제품이 있는 경우 수량과 총금액을 합산해서 새로 금액 정보들(마진, srp) 계산
                    if key_item in dict_item:
                        dict_item[key_item]['qty'] += float(tmp_qty)
                        dict_item[key_item]['amount'] += float(row[26].value)
                        list_item[dict_item[key_item]['idx']][25] = dict_item[key_item]['qty']
                        list_item[dict_item[key_item]['idx']][26] = dict_item[key_item]['amount']
                        list_item[dict_item[key_item]['idx']][22] = dict_item[key_item]['amount'] / dict_item[key_item]['qty']
                        result_old_case_cost, result_new_case_cost, result_price, result_old_margin, result_new_margin, result_srp = getSrpSet(list_item[dict_item[key_item]['idx']][21], list_item[dict_item[key_item]['idx']][29], list_item[dict_item[key_item]['idx']][22], list_item[dict_item[key_item]['idx']][31], list_item[dict_item[key_item]['idx']][27])
                        list_item[dict_item[key_item]['idx']][29] = result_old_case_cost
                        list_item[dict_item[key_item]['idx']][30] = result_new_case_cost
                        list_item[dict_item[key_item]['idx']][31] = result_price
                        list_item[dict_item[key_item]['idx']][32] = result_old_margin
                        ...
                        if result_srp != None and result_srp != '' and result_srp != ' ':
                            if dict_item[key_item]['key_srp_2'] == -1:
                                dict_item[key_item]['key_srp_2'] = len(dict_srp_store_date[str(tmp_sc)+'_'+str(tmp_date)])
                                dict_srp_store_date[str(tmp_sc)+'_'+str(tmp_date)].append([result_upc, '', tmp_sc, tmp_vc, result_ic, 'CASE', '1', '1', list_item[dict_item[key_item]['idx']][21], result_new_case_cost, tmp_date, '1', tmp_vat, result_old_case_cost, result_new_case_cost, result_price, result_old_margin, result_new_margin, result_srp, True])
                            else:
                                dict_srp_store_date[str(tmp_sc)+'_'+str(tmp_date)][dict_item[key_item]['key_srp_2']] = [result_upc, '', tmp_sc, tmp_vc, result_ic, 'CASE', '1', '1', list_item[dict_item[key_item]['idx']][21], result_new_case_cost, tmp_date, '1', tmp_vat, result_old_case_cost, result_new_case_cost, result_price, result_old_margin, result_new_margin, result_srp, True]
                        else:
                            if dict_item[key_item]['key_srp_2'] > -1:
                                dict_srp_store_date[str(tmp_sc)+'_'+str(tmp_date)][dict_item[key_item]['key_srp_2']][-1] = False
                            if dict_item[key_item]['key_srp_non'] == -1:
                                dict_item[key_item]['key_srp_non'] = len(list_non_srp_store_date)
                                list_non_srp_store_date.append([row[1].value, result_upc, tmp_sc, tmp_vc, result_ic, list_item[dict_item[key_item]['idx']][21], tmp_date, tmp_vat, result_old_case_cost, result_new_case_cost, result_price, result_old_margin, result_new_margin, True])
                    # 중복되는 제품이 없는 경우 dict에 새로 추가하고 만약 srp가 있는 값이면 srp추가와 함께 추가된 srp의 인덱스를 받음
                    # list_item에서의 인덱스도 무조건 저장
                    else:
                        dict_item[key_item] = {
                            'idx': len(list_item)
                            , 'key_srp_1': str(tmp_sc)+'_'+str(tmp_date)
                            , 'key_srp_2': len(dict_srp_store_date[str(tmp_sc)+'_'+str(tmp_date)]) if tmp_srp and tmp_srp != '' and tmp_srp != ' ' else -1
                            , 'key_srp_non': len(list_non_srp_store_date) if (tmp_srp is None or tmp_srp == '' or tmp_srp == ' ') and tmp_desc_lookup_base in ['U', 'I'] else -1
                            , 'key_srp_upon_zero': len(list_srp_store_data_upon_zero_margin) if tmp_srp and tmp_srp != '' and tmp_srp != ' ' and result_new_margin > 0 else -1
                            , 'key_srp_minus': len(list_srp_minus_margin) if tmp_srp and tmp_srp != '' and tmp_srp != ' ' and result_new_margin <= 0 else -1
                            , 'file_name': arr1[1]
                            , 'qty': float(tmp_qty)
                            , 'amount': float(row[26].value)
                        }
                        ...
                        if tmp_srp != None and tmp_srp != '' and tmp_srp != ' ':
                            dict_srp_store_date[str(tmp_sc)+'_'+str(tmp_date)].append([result_upc, '', tmp_sc, tmp_vc, result_ic, 'CASE', '1', '1', tmp_csize, result_new_case_cost, tmp_date, '1', tmp_vat, result_old_case_cost, result_new_case_cost, result_price, result_old_margin, result_new_margin, tmp_srp, True])
                            if result_new_margin > 0:
                                list_srp_store_data_upon_zero_margin.append([row[1].value, result_upc, tmp_sc, tmp_vc, tmp_ic, tmp_csize, tmp_date, tmp_vat, result_old_case_cost, result_new_case_cost, result_price, result_old_margin, result_new_margin, tmp_srp, True])
                            else:
                                list_srp_minus_margin.append([row[1].value, result_upc, tmp_sc, tmp_vc, tmp_ic, tmp_csize, tmp_date, tmp_vat, result_old_case_cost, result_new_case_cost, result_price, result_old_margin, result_new_margin, tmp_srp, True])
                        elif tmp_desc_lookup_base in ['U', 'I']:
                            list_non_srp_store_date.append([row[1].value, result_upc, tmp_sc, tmp_vc, tmp_ic, tmp_csize, tmp_date, tmp_vat, result_old_case_cost, result_new_case_cost, result_price, result_old_margin, result_new_margin, True])
                '''
    ...
    if vc and sc and vc in g_data['dict_vendor_item_code']:
        ...
        if idx_ic > -1:
            if tmp_upc in refer_idata[ic_cand[idx_ic]]:
                return refer_idata[ic_cand[idx_ic]][tmp_upc]['csize']
            else:
                idx_upc = -1
                idx_tmp = 0
                for item in tmp_upc_cand:
                    ...
                    idx_tmp += 1
                if idx_upc > -1:
                    return refer_idata[ic_cand[idx_ic]][tmp_upc_cand[idx_upc]]['csize']
        ...
        if tmp_upc in refer_udata:
            ...
            for item in ic_cand:
                ...
                idx_tmp += 1
            if idx_ic > -1:
                return refer_udata[tmp_upc][ic_cand[idx_ic]]['csize']
        idx_upc = -1
        idx_tmp = 0
        for item in tmp_upc_cand:
        ...
        if idx_upc > -1:
            ...
            for item in ic_cand:
                ...
                idx_tmp += 1
            if idx_ic > -1:
                return refer_udata[tmp_upc_cand[idx_upc]][ic_cand[idx_ic]]['csize']
    return org_csize