...
if not isdir('./postprocess/result/'+date_output):
    mkdir('./postprocess/result/'+date_output)
...
for sc in dict_sc:
    ...
    for key in dict_sc[sc]['ORG']:
        ...
        if key in dict_sc[sc]['RB_IDX'] or key in dict_sc[sc]['SW_IDX']:
            ...
            if key in dict_sc[sc]['CB_UDF_IDX']:
                ...
                idx1 += 1
                ws_n_1.cell(idx1+1, 19).number_format = '0%'
                ws_n_1.cell(idx1+1, 20).number_format = '0%'
            if arr_item_floor[1] == '고마진/저마진 확인 요망':
                arr_item_floor[1] = ''
    ...
    print(ws_n_1.title+': '+str(ws_n_1.max_row - 1))
    ...
    print((ws_n_1.max_row + ws_n_2.max_row + ws_n_3.max_row + ws_n_4.max_row - 4 - cnt_sr_srp)) # 1250
    print((ws_n_5.max_row - 1) == (ws_n_1.max_row + ws_n_2.max_row + ws_n_3.max_row + ws_n_4.max_row + ws_n_10.max_row - 5 - cnt_sr_srp))
    ...
    wb_n.save('./postprocess/result/'+date_output+'/'+date_output+' '+dict_store[sc]+' CPB.xlsx')
